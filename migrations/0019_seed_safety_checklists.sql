-- Migration 0019: Seed 9 universal safety checklists for all 3 projects
-- These are the standard checklists that should exist on every project.
-- They are universal across all companies.
